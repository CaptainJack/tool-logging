...
class JsSyntheticTranslateExtension() : JsSyntheticTranslateExtension {
	...
	private var fqNameGetLogger = FqName("ru.capjack.kt.logging.Logging.getLogger")
	private var fqNameGetLoggerExt = FqName("ru.capjack.kt.logging.getLogger")
	...
	private fun processProperty(context: TranslationContext, property: KtProperty) {
		...
		if (BindingUtils.getDescriptorForReferenceExpression(bindingContext, target)?.fqNameSafe != fqNameLogging) {
			return
		}
